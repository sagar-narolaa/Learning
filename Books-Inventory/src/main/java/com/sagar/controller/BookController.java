...
public class BookController {
	...
	/*
	 * @GetMapping("/count") private String count() throws SQLException,
	 * IOException, ServletException { //excelGenerated++;
	 * System.out.println("Count = " + excelGenerated); return "redirect:/list"; }
	 */

	@GetMapping("/generateExcel")
	private String generateExcel(RedirectAttributes redirectAttributes) throws SQLException, IOException, ServletException {
	...
	private String listBook(Model model,@RequestParam("excelGenerated") int excelStatus) throws SQLException, IOException, ServletException {
		List<Book> listBooks = bookService.getAll();
		model.addAttribute("listBooks", listBooks);
