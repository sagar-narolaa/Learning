 ...
 * java.io.OutputStream; import java.sql.SQLException; import
 * java.util.ArrayList; import java.util.List; import java.util.Map; import
 * java.util.Properties; import java.util.Set; import java.util.TreeMap;
 * 
 ...
 * 
 * import com.sagar.dao.BookDao; import com.sagar.model.Book;
 * 
 * @Service("ExcelJPA") public class ExcelServiceJPAimpl implements ExcelService
 * {
 * 
 * @Autowired
 * 
 * @Qualifier("booksJPA") BookDao bookDao;
 * 
 * @Override public List<Object> getColumnData() { List<Book> books =
 * bookDao.findAll(); List<Object> obj = new ArrayList<Object>();
 * books.forEach((book) -> obj.add(book)); return obj; }
 * 
 ...
 * return obj; }
 * 
 * @Override public int generateExcel() throws FileNotFoundException,
 * SQLException { List<Object> columnData=getColumnData(); List<Object>
 ...
 * data.put(0,(ArrayList<Object>) columnNames );
 * 
 * for (int i = 0; i <columnData.size(); i++) { ArrayList<Object> obj=new
 * ArrayList<Object>(); Book book=(Book)columnData.get(i);
 * obj.add(book.getId()); obj.add(book.getName()); obj.add(book.getISBN());
 * obj.add(book.getAuthor()); data.put(i+1, obj); }
 * 
 * 
 * for (int i = 0; i <columnData.size(); i++) { data.put(i+1,
 * (ArrayList<Object>) columnData.get(i)); }
 ...
 * :objArr) { cell = row.createCell(cellnum++); if (objj instanceof String)
